...
<body class="vsc-initialized" onload="showClock()">
	<div>
		<div class="main">
			<div class="header">
				<span class="px-3" ><!-- onclick="location.href='pos-calendar.html'"--> <svg xmlns="http://www.w3.org/2000/svg"  onclick="posmanage()" width="30" height="30" fill="currentColor" class="bi bi-gear-wide-connected" viewBox="0 0 16 16" >
                    ...
                    </svg></span> <img src="/resources/image/mainLogo-dark.png" >
			</div>

			<div class="contents">
				<span class="mainContent border" style="display: grid; grid-template-columns: 1fr 1fr 1fr; grid-template-rows: 1fr 1fr 1fr; gap: 5%;">
					...
					<div class="toast" role="alert" aria-live="assertive" aria-atomic="true" style="display: block; position: absolute; left: 70%; top: 3%; z-index: 1;">
						<div class="toast-header">
							...
							<strong class="me-auto">&nbsp POS<span style="color: #1ED760;">.</span>T<span style="color: #1ED760;">LUCK</span></strong> <small class="text-muted">5분전</small>
							<button type="button" class="btn-close" data-bs-dismiss="toast" aria-label="Close"></button>
						</div>
						<div class="toast-body">새로운 주문이 들어왔습니다.</div>
					</div>

					<div class="card" style="width: 18rem; position: absolute; top: 20%; left: 50%; z-index: 1;">
						<!-- <img src="..." class="card-img-top" alt="..."> -->
						<div class="card-body">
							<span style="position: absolute; top: 0.5%; left: 70%;">
								<div style="text-align: center;">
									<span id="apm" style="color: gray; font-size: 15px;">ampm</span> <span id="clock" style="color: gray; font-size: 15px;">clock</span>
								</div>
							</span>
							<h5 class="card-title" style="">#주문번호</h5>
							<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
							<a href="#" class="btn btn-primary">Go somewhere</a>
						</div>
					</div>
					<div class="order p-3 position-relative">
						<div class="orderInfo1">
							<span class="h4"><strong> # 22 </strong></span><span> 11:22</span>
						</div>
						<div>
							<div>치킨 햄버거 x 1</div>
							<div>치킨 햄버거 x 1</div>
						...
						<div>외 8건</div>
						<div class="position-absolute bottom-0 pe-3">
							<h4>
								총 <strong>80,000</strong>원
							</h4>
						</div>
					</div>
					<div class="order p-3 position-relative ">
					...
					<div class="order p-3 position-relative">
						...
						<div>외 8건</div>
						<div class="position-absolute bottom-0 pe-3" style="width: 100%;">
							<h4 class="text-end p-3">
								총 <strong>80,000</strong>원
							</h4>
						</div>
					</div>
	...
	<script>
        ...
        function posmanage(){
        	serverCallByFetchAjax('getJWT()','posmanage','post','');
        }
    </script>
