...
<body class="vsc-initialized" onload="pageInit('');showClock()" style="">
	...
	<div class="main">
		...
		<div class="contents">
			...
			<div class="mainContent border row justify-content-start"
				...
				<div class="col-4 p-5 mx-3 h-100 rounded"
					...
					<div class="row">
						<button class="btn btn-outline-primary w-100" type="button"
							...
							aria-controls="offcanvasWithBothOptions">주문</button>
					</div>
				</div>


				<div class="col-4 p-5 mx-3 h-100 rounded"
					style="overflow-y: auto; background: white;"></div>
				<div class="col-4 p-5 mx-3 h-100 rounded"
					style="overflow-y: auto; background: white;"></div>
				<div class="col-4 p-5 mx-3 h-100 rounded"
					style="overflow-y: auto; background: white;"></div>
