...
<body>
    ...
    <div class="main">
        <div class="header"><span class="px-3 " style="cursor:pointer"><svg xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="content">
            <div class="sidebar border d-flex border">
                ...
                <div class="border p-3 d-flex"
                    style="justify-content: space-between ;height:7%;  background-color: white;">영업전 <div
            ...
            <div class="mainContent" id="menu4" style="display: none;">
                ...
                <div class="inputZone p-5 d-flex gap-3" style="flex-direction: column;">
                    <div class="salesPeriodButtonZone" style="margin-left: 5%; ">
                        <button type="button" class="btn btn-outline-primary" style="font-weight: bold;"> &nbsp 영업중
                            &nbsp </button>
                        <button type="button" class="btn btn-outline-primary" style="font-weight: bold;">&nbsp &nbsp 1주
                            &nbsp &nbsp</button>
                        <button type="button" class="btn btn-outline-primary" style="font-weight: bold;"> &nbsp 1개월
                            &nbsp </button>
                        <button type="button" class="btn btn-outline-primary" style="font-weight: bold;">&nbsp 3개월 &nbsp
                        </button>
                ...
                <div class="mainContentMidlle" style="max-width: 100%; height: 20%;">
                    <div class="salesTextZone">
                        <div class="textBox">
                            실매출<br>
                            <span style="font-size: 30px;">201,800원</span>
                        </div>
                        <div class="textBox">
                            결제건수<br>
                            <span style="font-size: 30px;">6건</span>
                        </div>
                        <div class="textBox">
                            주문건단가<br>
                            <span style="font-size: 30px;">33,633원</span>
                        </div>
                    ...
                    <div class="salesTextZone">
                        ...
                        <div class="textBox">
                            환불건단가<br>
                            <span style="font-size: 30px;">13,450원</span>
                        </div>
                    ...
                    <div class="footerChoiceTab" style="margin: 2%; position: relative; left: 6%;">
                        <ul class="nav nav-tabs" role="tablist" style="margin-bottom: 1.5%;">
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" data-bs-toggle="tab" href="#home" aria-selected="false" role="tab"
                                    tabindex="-1">결제수단별</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active" data-bs-toggle="tab" href="#profile" aria-selected="true"
                                    role="tab">메뉴별</a>
                            </li>
