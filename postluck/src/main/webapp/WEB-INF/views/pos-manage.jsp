...
<body class="vsc-initialized">
				...
				<div class="inputZone p-5 d-flex gap-3"
					...
					<div class="salesPeriodButtonZone">
						<button type="button" class="btn btn-outline-primary"
							style="font-weight: bold;" class="date"
							onClick="selSalesperiod('today')">&nbsp 오늘 &nbsp</button>
						<button type="button" class="btn btn-outline-primary"
							style="font-weight: bold;" class="date"
							onClick="selSalesperiod('oneWeek')">&nbsp &nbsp 1주 &nbsp
							&nbsp</button>
						<button type="button" class="btn btn-outline-primary"
							style="font-weight: bold;" class="date"
							onClick="selSalesperiod('oneMonth')">&nbsp 1개월 &nbsp</button>
						<button type="button" class="btn btn-outline-primary"
							style="font-weight: bold;" class="date"
							onClick="selSalesperiod('threeMonth')">&nbsp 3개월 &nbsp</button>
					</div>
				</div>
				...
				<div class="mainContentFooter p-5">
					<div class="footerChoiceTab" style="position: relative;">
						<ul class="mb-5 nav nav-tabs" role="tablist">
							<li class="nav-item" role="presentation"onclick="paymentTypeList()"><a class="nav-link"
								data-bs-toggle="tab" href="#home" aria-selected="false"	role="tab" tabindex="-1">결제수단별</a></li>
							<li class="nav-item" role="presentation"onclick="menuTypeList()"><a	class="nav-link active" data-bs-toggle="tab" href="#profile"
								aria-selected="true" role="tab">메뉴별</a></li>
							<li class="nav-item" role="presentation"onclick="selLocateList()"><a class="nav-link"data-bs-toggle="tab" href="#locate" aria-selected="false"
						...
						<div id="myTabContent" class="tab-content"
							...
							<div class="tab-pane fade" id="home" role="tabpanel">
								<div class="paymentTab"
									style="width: 80%; display: flex; flex-direction: row; font-size: 20px;"id="selpaymentList"></div>
									</div>
	...
	function selSalesPeriod(jsonData){
		...
		function selPaymentTypeList(j){
			...
			const paymentTotal = paymentData[0].totalPrice+paymentData[1].totalPrice
			...
			selpaymentListZone.innerHTML='';
			  const paymentInfo =`
				...
				<div class="textBox1">
					...
					\${paymentData[0].totalPrice}원<br> <br> \${paymentData[1].totalPrice}원
					<hr style="border: 1px color= silver; width: 100%;">
				</div>`;
				const actualSales=`
			<div class="actualSales"
				...
				<span style="font-size: 20px;">\${paymentTotal}원</span>	</div> `;
				
				  selpaymentListZone.innerHTML+=paymentInfo;
				  selpaymentListZone.innerHTML+=actualSales;
